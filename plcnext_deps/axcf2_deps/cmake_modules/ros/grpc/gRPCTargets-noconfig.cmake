...
set_target_properties(gRPC::address_sorting PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libaddress_sorting.so.23.0.0"
  IMPORTED_SONAME_NOCONFIG "libaddress_sorting.so.23"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::address_sorting )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::address_sorting "${_IMPORT_PREFIX}/lib/libaddress_sorting.so.23.0.0" )
...
set_target_properties(gRPC::gpr PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgpr.so.23.0.0"
  IMPORTED_SONAME_NOCONFIG "libgpr.so.23"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::gpr )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::gpr "${_IMPORT_PREFIX}/lib/libgpr.so.23.0.0" )
...
set_target_properties(gRPC::grpc PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc.so.23.0.0"
  IMPORTED_SONAME_NOCONFIG "libgrpc.so.23"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc "${_IMPORT_PREFIX}/lib/libgrpc.so.23.0.0" )
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc_unsecure.so.23.0.0"
  IMPORTED_SONAME_NOCONFIG "libgrpc_unsecure.so.23"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc_unsecure )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc_unsecure "${_IMPORT_PREFIX}/lib/libgrpc_unsecure.so.23.0.0" )

# Import target "gRPC::grpc++" for configuration ""
set_property(TARGET gRPC::grpc++ APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(gRPC::grpc++ PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc++.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc++.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++ )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++ "${_IMPORT_PREFIX}/lib/libgrpc++.so.1.45.2" )
...
set_target_properties(gRPC::grpc++_alts PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc++_alts.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc++_alts.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_alts )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_alts "${_IMPORT_PREFIX}/lib/libgrpc++_alts.so.1.45.2" )
...
set_target_properties(gRPC::grpc++_error_details PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc++_error_details.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc++_error_details.so.1.45"
  )
...
set_target_properties(gRPC::grpc++_reflection PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc++_reflection.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc++_reflection.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_reflection )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_reflection "${_IMPORT_PREFIX}/lib/libgrpc++_reflection.so.1.45.2" )
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc++_unsecure.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc++_unsecure.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc++_unsecure )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc++_unsecure "${_IMPORT_PREFIX}/lib/libgrpc++_unsecure.so.1.45.2" )
...
set_target_properties(gRPC::grpc_plugin_support PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpc_plugin_support.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpc_plugin_support.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpc_plugin_support )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpc_plugin_support "${_IMPORT_PREFIX}/lib/libgrpc_plugin_support.so.1.45.2" )
...
set_target_properties(gRPC::grpcpp_channelz PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgrpcpp_channelz.so.1.45.2"
  IMPORTED_SONAME_NOCONFIG "libgrpcpp_channelz.so.1.45"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::grpcpp_channelz )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::grpcpp_channelz "${_IMPORT_PREFIX}/lib/libgrpcpp_channelz.so.1.45.2" )
...
set_target_properties(gRPC::upb PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libupb.so.23.0.0"
  IMPORTED_SONAME_NOCONFIG "libupb.so.23"
  )

list(APPEND _IMPORT_CHECK_TARGETS gRPC::upb )
list(APPEND _IMPORT_CHECK_FILES_FOR_gRPC::upb "${_IMPORT_PREFIX}/lib/libupb.so.23.0.0" )
