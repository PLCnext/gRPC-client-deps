...
#cp -v axcf2_deps/lib/libgpr.so.15.0.0 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++_alts.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc++_reflection.so.1 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libaddress_sorting.so.15 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpcpp_channelz.so.1 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++_unsecure.so.1 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc.so.15 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++.so.1 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libgrpc_plugin_support.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotobuf-lite.so.25 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libcares.so.2.4.0 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc++_reflection.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotobuf-lite.so.25.0.0 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++_error_details.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc_unsecure.so.15 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotobuf.so.25.0.0 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libabsl_examine_stack.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotoc.so.25.0.0 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc_unsecure.so.15.0.0 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libaddress_sorting.so.15.0.0 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libprotobuf-c.so.1.0.0 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgpr.so.15 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libupb.so.15.0.0 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libabsl_str_format_internal.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc++.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libupb.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libupb.so.15 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libabsl_flags.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc++_unsecure.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc_plugin_support.so.1 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++_error_details.so.1 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpcpp_channelz.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc.so.15.0.0 /opt/ros/$ROS_DISTRO/lib
cp -v axcf2_deps/lib/libprotobuf-lite.so /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotobuf.so.25 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libprotoc.so.25 /opt/ros/$ROS_DISTRO/lib
#cp -v axcf2_deps/lib/libgrpc_plugin_support.so.1.36.4 /opt/ros/$ROS_DISTRO/lib
...
#cp -v axcf2_deps/lib/libgrpc++_alts.so.1 /opt/ros/$ROS_DISTRO/lib
